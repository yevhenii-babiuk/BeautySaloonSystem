...
public class SignUpSlotActionTest {
    ...
    private SignUpSlotAction action;

    @Before
    public void init() {
        action = spy(new SignUpSlotAction());
    ...
    public void executeShouldSetSuccessfulAttribute(){
        ...
        action.execute(request, response, form, resources);
        verify(request).setAttribute("actionResult", "slotSearch.result.successfulSignUp");
    }
    ...
    public void executeShouldSetFailedAttribute(){
        ...
        action.execute(request, response, form, resources);
        verify(request).setAttribute("actionResult", "slotSearch.result.failedSignUp");
    }
