        ...
        <table class="table table-hover table-sm">
            ...
            <c:forEach var="slotDTO" items="${slots}">
                <tr>
                    ...
                    <td>
                        <c:if test="${slotDTO.slot.status eq 'BOOKED'}">
                            <fmt:message key="slotSearch.statusBooked"/>
                        </c:if>
                        <c:if test="${slotDTO.slot.status eq 'FREE'}">
                    ...
                    <td>
                        <c:if test="${language eq 'en'}">
                            ${slotDTO.procedure.descriptionEn}
                        </c:if>
                        <c:if test="${language eq 'ru'}">
                            ${slotDTO.procedure.descriptionRus}
                        </c:if>
                        <c:if test="${language eq 'ua'}">
                            ${slotDTO.procedure.descriptionUkr}
                        </c:if>
                    </td>
                </tr>
            </c:forEach>
